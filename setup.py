...
setup(
    ...
    #
    # 1. Create the function you want to run on the CLI in src/common_lib_fos/cli.py
    #    For convenience I usually recommend calling it main()
    #
    # 2. Uncomment this section of the setup.py arguments; this will create
    #    bin/Common_Lib_FOS (which you can obviously change!) as a script
    #    that will call your main() function, above.
    #
    # entry_points="""\
    # [console_scripts]
    # Common_Lib_FOS = common_lib_fos.cli:main
    # """,
    #
